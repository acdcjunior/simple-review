...
$couch = new CouchSimple(); // See if we can make a connection
$resp = $couch->send("GET", "/");
...
$resp = $couch->send("PUT", "/test/". $rand, '{"_id":"'.$rand.'","data":"FooRAND"}');

$resp = $couch->send("POST", "/test/", '{"data":"POSTED!"}');
