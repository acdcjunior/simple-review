...
class GitLabConfig {
    ...
    static projectsUrl (perPage) {
        let perPageEfetivo = perPage || 10;
        return `http://${host}/api/v4/projects/${projectId}/repository/commits/?ref_name=${projectBranch}&per_page=${perPageEfetivo}`;
    }
