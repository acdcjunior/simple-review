...
function corsConfig() {
    return new Promise((resolve, reject) => {
        console.log(`[CORS] Tentando configurar CouchDB em http://${couchDbConfig_1.couchDbConfig.couchdbHost}:${couchDbConfig_1.couchDbConfig.couchdbPort}, com user=${couchDbConfig_1.couchDbConfig.couchdbUser} e password=${couchDbConfig_1.couchDbConfig.couchdbPassword}...`);
