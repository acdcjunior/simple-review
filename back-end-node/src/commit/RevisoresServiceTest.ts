...
const committers = [
    /* 0 */  new Committer(gu('alexandrevr@example.com',    "Alexandre Silva Santos (ALEXANDREVR)",            'alexandrevr'),  [],          25, "m"),
    /* 1 */  new Committer(gu('antonio.junior@example.com', "Antonio C. de Carvalho Junior (CARVALHOJ)",    'carvalhoj'),    ["antonio"], 40, "m"),
    /* 2 */  new Committer(gu('marcosps@example.com',       "Marcos Paulo Santos da Silva (MARCOSPS)",     'marcosps'),     ["marcos"],  25, "m"),
    /* 3 */  new Committer(gu('regiano@example.com',        "Regiano da Silva Santos (REGIANO)",             'regiano'),      [],          10, "m"),
    /* 4 */  new Committer(gu('fernandesm@example.com',     "Jose Mauricio Santos (FERNANDESM)",         'fernandesm'),   [],          0,  "m"),
    /* 5 */  new Committer(gu('leliakn@example.com',        "Lelia Silva (LELIAKN)",                 'LELIAKN'),      ["lelia"],   0,  "f"),
    /* 6 */  new Committer(gu('carlanm@example.com',        "Carla Souza (CARLANM)",      'CarlaNM'),      [],          0,  "f"),
    /* 7 */  new Committer(gu('x04992831131@example.com',   "Gabriel Mesquita de Araujo (X04992831131)",    'x04992831131'), [],          25, "m"),
    /* 8 */  new Committer(gu('x05068388213@example.com',   "Rebeca Andrade Silva (X05068388213)",       'x05068388213'), [],          25, "f"),
    /* 9 */  new Committer(gu('x05499033332@example.com',   "Afonso Santos de Souza Silva (X05499033332)", 'x05499033332'), ["afonso"],  25, "m"),
    /* 10 */ new Committer(gu('x05929988846@example.com',   "Bruno Silva Santos Souza (X05929988846)",  'x05929988846'), [],          25, undefined),
];
