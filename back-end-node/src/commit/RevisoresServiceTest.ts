...
Email.corrigirEmail = (email) => email.replace(/@.*\.example\.com$/g, '@example.com').toLowerCase();
Email.prototype.isEmailDeEstagiario = function() { return /[xX]\d{11}@example.com$/.test(this.email) };

const FAKE_BOT_USERNAME = 'fake-bot-username';
(codeReviewConfig.botComentador as any).username = FAKE_BOT_USERNAME;
...
const committers = [
    /* 0 */  new Committer(gu('alexandrevr@example.com',    "Alexandre Souza Silva (ALEXANDREVR)",        'alexandrevr'),  null, [],          25, "m"),
    /* 1 */  new Committer(gu('antonio.junior@example.com', "Antonio C. de Carvalho Junior (CARVALHOJ)",  'carvalhoj'),    null, ["antonio"], 40, "m"),
    /* 2 */  new Committer(gu('marcosps@example.com',       "Marcos Paulo Barbosa Silva (MARCOSPS)",      'marcosps'),     null, ["marcos"],  25, "m"),
    /* 3 */  new Committer(gu('regiano@example.com',        "Regiano Smith (REGIANO)",                    'regiano'),      null, [],          10, "m"),
    /* 4 */  new Committer(gu('fernandesm@example.com',     "Jose Mauricio Silva (FERNANDESM)",           'fernandesm'),   null, [],          0,  "m"),
    /* 5 */  new Committer(gu('leliakn@example.com',        "Lelia Souza Silva (LELIAKN)",                'LELIAKN'),      null, ["lelia"],   0,  "f"),
    /* 6 */  new Committer(gu('carlanm@example.com',        "Carla Silva Santos (CARLANM)",               'CarlaNM'),      null, [],          0,  "f"),
    /* 7 */  new Committer(gu('x04992831131@example.com',   "Gabriel Mosquete Silva (X04992831131)",      'x04992831131'), null, [],          25, "m"),
    /* 8 */  new Committer(gu('x05068388213@example.com',   "Rebeca Skywalker (X05068388213)",            'x05068388213'), null, [],          25, "f"),
    /* 9 */  new Committer(gu('x05499033332@example.com',   "Afonso Santos (X05499033332)",               'x05499033332'), null, ["afonso"],  25, "m"),
    /* 10 */ new Committer(gu('x05929988846@example.com',   "Bruno Silva Santos (X05929988846)",          'x05929988846'), null, [],          25, undefined),
