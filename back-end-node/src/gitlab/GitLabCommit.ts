export class GitLabCommit {
    ...
    public id: string; // "2e765c5d714588c9e08a485c332df403e22726b9",
    public short_id: string; // "2e765c5d",
    public title: string; // "test(instrucao): Testando construção do email na operação retomar instrução.",
